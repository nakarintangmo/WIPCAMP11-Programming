...
public class project {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("เลือกเมนู  : "); menu = input.nextInt();
        if (menu == 1) {
            if (item <= limit) {
                int amout;
                System.out.print("add amout : ");
                amout = input.nextInt();
                if (item + amout > limit) {
            ...
            if (item > 0) {
                ...
                System.out.println("ไอเท็มไม่มีในโกดัง");
            }
        } else if (menu == 3) {
